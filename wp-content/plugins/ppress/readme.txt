=== Custom Login, Registration & Password Reset Form Builder for WordPress - ProfilePress ===
Contributors: Collizo4sky
Donate link: https://profilepress.net/pricing/
Tags: login, user registration, password reset, frontend, members, sidebar, registration, profile, front-end profile, edit profile, avatar, custom login, custom registration, custom password reset, frontend login, front-end profile, shortcode, ajax, registration, pie-register, custom fields, file uploads, form builder, front-end login, front-end registration, log in, sidebar, sidebar login, wordpress login, facebook login, google login, linkedin login, github, form, twitter, twitter login, gravatar, hide wp-admin, avatar upload, custom field registration, captcha, recaptcha, custom redirects, custom registration, custom registration form, ultimate member, profile, customize registration email, edit profile, email confirmation, extra user fields, front-end edit profile, front-end login, front-end register, front-end registration, front-end user registration, login redirect, login widget, password strength, password strength meter, profile builder, register form, registration, registration page, user approval, user custom fields, user email, user listing, user login, user profile, widget, pie register, social login
...
== Description ==
Ever wanted to create a front-end login form, front-end registration form and front-end password reset form that will conform to a WordPress (theme) design?
...
**Note: This is the lite version of ProfilePress plugin. Want even more features? [Click here to purchase the best custom login, registration, password reset forms builder and account manager plugin now!](https://profilepress.net/pricing/)**
